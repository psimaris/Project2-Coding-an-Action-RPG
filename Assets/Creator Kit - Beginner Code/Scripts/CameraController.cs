...
namespace CreatorKitCodeInternal 
{
    ...
    public class CameraController : MonoBehaviour
    {
        ...
        public CinemachineCamera Camera { get; protected set; }
   
        protected float m_CurrentDistance = 1.0f;
        protected CinemachinePositionComposer PositionComposer;
        ...
        public void Zoom(float distance)
        {
            ...
            PositionComposer.CameraDistance = Mathf.Lerp(MinDistance, MaxDistance, m_CurrentDistance);
